...
class ExpressAppConfig {
    constructor(definitionPath, appOptions) {
        ...
        // this.app.use(bodyParser.urlencoded({ limit: '500gb' , extended: true }));
        // this.app.use(bodyParser.text());
        // this.app.use(bodyParser.json({ limit: '500gb' }));
        this.app.use(this.configureLogger(appOptions.logging));
        this.app.use(express.json({ limit: '500gb' }));
        this.app.use(express.urlencoded({ limit: '500gb' , extended: true }));
        this.app.use(cors());
